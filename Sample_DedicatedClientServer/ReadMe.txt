========================================================================
    APPLICATION CONSOLE : Vue d'ensemble du projet Sample_05_DedicatedClientServer
========================================================================

AppWizard a créé cette application Sample_05_DedicatedClientServer pour vous.

Ce fichier contient un résumé du contenu de chacun des fichiers qui constituent votre application Sample_05_DedicatedClientServer.


Sample_05_DedicatedClientServer.vcxproj
...
Sample_05_DedicatedClientServer.vcxproj.filters
...
Sample_05_DedicatedClientServer.cpp
...
StdAfx.h, StdAfx.cpp
    Ces fichiers sont utilisés pour générer un fichier d'en-tête précompilé (PCH) Sample_05_DedicatedClientServer.pch et un fichier de type précompilé nommé StdAfx.obj.
